...
<div class="container-fluid highlight-jumbotron">
  ...
  <div class="col-lg-4 col-lg-push-4 col-md-12 homepage-intro">
    <div class="homepage-logo">
      <p class="sans-serif-800" align="left">VITAL</p>
      <p class="serif-400" align="left">Videos for Italian Teaching and Learning</p>
    </div>
  ...
  <div class="col-lg-4 col-lg-pull-4 col-md-6 col-sm-12">
    ...
    <div class="section">
      ...
      <div class="back">
        ...
        <a href="<?php echo $sectionLinks[0] ?>"><?php echo $sectionTitle1s[0] ?></a>
      </div>
    </div>
    ...
    <?php endif ?>
      ...
      <div class="back">
        ...
        <a href="<?php echo $sectionLinks[1] ?>"><?php echo $sectionTitle1s[1] ?></a>
      </div>
    </div>
  ...
  <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <?php endif ?>
      ...
      <div class="back">
        ...
        <a href="<?php echo $sectionLinks[2] ?>"><?php echo $sectionTitle1s[2] ?></a>
      </div>
    </div>
    ...
    <?php endif ?>
      ...
      <div class="back">
        ...
        <a href="<?php echo $sectionLinks[3] ?>"><?php echo $sectionTitle1s[3] ?></a>
      </div>
    </div>
